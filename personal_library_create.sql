...
CREATE USER 'librarian_user'@'localhost' IDENTIFIED WITH mysql_native_password BY 'UPDATEWITHPASSWORD';

-- Drop and create database
DROP DATABASE IF EXISTS personal_library;
CREATE DATABASE personal_library;
GRANT ALL PRIVILEGES ON personal_library.* TO 'librarian'@'localhost';
